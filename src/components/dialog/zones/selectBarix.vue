...
const onOkDialog = async () => {
  if (selected.value === null) {
    ...
    const r = await api.get('/devices/qsys/existszone', {
...
<template>
  <q-dialog ref="dialogRef" @hide="onDialogHide">
    <q-card class="q-dialog-plugin" style="border-radius: 0.6rem">
      <q-card-section>
        <div class="q-px-sm q-gutter-x-sm row no-wrap items-center">
          <q-icon name="location_on" color="primary" size="1.2rem" />
